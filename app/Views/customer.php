        ...
        <div class="page-heading">
          ...
          <section class="section">
            <div class="card">
              ...
              <a href="<?=base_url('/Home/tambah_customer/')?>" style="position: absolute; top: 10px; right: 10px;">
                                 ...
                                 $no=1;
                                  foreach ($okta as $b) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?=base_url('/Home/edit_customer/'.$b->id_jadwal)?>"><button class="btn btn-primary">Edit</button></a>
                                        <a href="<?=base_url('/Home/delete_customer/'.$b->id_jadwal)?>"><button class="btn btn-danger">Delete</button></a>    
                                        </td>
